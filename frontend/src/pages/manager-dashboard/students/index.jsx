// frontend\src\pages\manager-dashboard\students\index.jsx
"use client";
  ...
  return (
    <div className="bg-[#1a1d23] p-5 rounded-2xl border border-gray-800 hover:border-blue-400/50 transition-all duration-300 shadow-xl group">
      ...
      <div className="flex justify-end gap-2 mt-5">
        <Link
          href={`/manager-dashboard/students/${user.id}/edit`}
    ...
    return (
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center py-20 text-blue-400 font-black animate-pulse">
          ...
          در حال فراخوانی لیست زبان آموزان...
        </div>
      </DashboardLayout>
    );
    ...
    <DashboardLayout>
      <div className="p-4 sm:p-8 min-h-screen bg-[#0F1420] rounded-[2.5rem] border border-gray-800 shadow-2xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-3xl font-black text-white italic tracking-tighter uppercase">
                مدیریت <span className="text-blue-400">زبان آموزان</span>
              </h2>
          ...
          <Link
            href="/manager-dashboard/students/create"
          ...
          <table className="w-full text-right">
            <thead>
              <tr className="bg-gray-800/50 text-gray-400 text-[11px] uppercase tracking-[0.2em] border-b border-gray-700">
                ...
                <th className="py-5 px-6 font-black">زیان آموز</th>
            ...
            <tbody className="divide-y divide-gray-800">
              {filteredUsers.length === 0 ? (
                <tr>
                  ...
                  >
                    ⚠️ هیچ زیان آموزی در این لیست یافت نشد
                  </td>
                </tr>
              ) : (
