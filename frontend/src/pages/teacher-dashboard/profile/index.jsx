...
import { FaLevelUpAlt, FaMoneyBill } from "react-icons/fa";
      ...
      <div className="p-4 sm:p-8 min-h-screen bg-[#0F1420] rounded-[2.5rem] border border-gray-800 shadow-2xl">
        ...
        <div className="max-w-3xl mx-auto bg-[#1a1d23] border border-gray-800 rounded-3xl p-6 shadow-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-300">
            ...
            <Info icon={Award} label="تخصص" value={user.specialization} />
            <Info icon={FaLevelUpAlt} label="سطح" value={user.level} />
            <Info icon={FaMoneyBill} label="حقوق" value={user.salary} />
